      ...
      <div style={{ marginTop: "3%" }}>
        <Container textAlign="justified">
          ...
          <div style={{ marginTop: "4%" }}>
            <Button label="Novo" circular color="orange" icon="clipboard outline" floated="right" as={Link} to="/form-entregador" />
            <br /><br /><br />
                ...
                {lista.map((entregador) => (
                  <Table.Row key={entregador.id}>
                    ...
                    <Table.Cell textAlign="center">
                      <Button inverted circular color="green" title="Clique aqui para editar os dados deste entregador" icon>
                        <Link to="/form-entregador" state={{ id: entregador.id }} style={{ color: 'green' }}>
                          <Icon name="edit" />
                        </Link>
                      </Button> &nbsp;
                      <Button inverted circular color="red" title="Clique aqui para remover este entregador" icon onClick={() => confirmaRemover(entregador.id)}>
                        <Icon name="trash" />
                      </Button>
                    </Table.Cell>
                  </Table.Row>
