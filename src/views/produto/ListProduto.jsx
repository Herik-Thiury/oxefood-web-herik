            ...
            <Table color="orange" sortable celled>
              <Table.Header>
                <Table.Row>
                  ...
                  <Table.HeaderCell>Entrega Mínima</Table.HeaderCell>
                  <Table.HeaderCell>Entrega Máxima</Table.HeaderCell>
                ...
                {lista.map((produto) => (
                  <Table.Row key={produto.id}>
                    ...
                    <Table.Cell textAlign="center">
                      ...
                      <Button inverted circular color="red" title="Clique aqui para remover este produto" icon onClick={() => confirmaRemover(produto.id)}>
                        <Icon name="trash" />
                      </Button>
                    </Table.Cell>
                  </Table.Row>
